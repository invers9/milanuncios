  ...
  return (
    <div className="mx-auto flex w-full max-w-[600px] flex-col items-center rounded-2xl bg-white px-6 md:px-20">
      ...
      <button
        ...
        className="mb-40 h-[70px] w-full rounded-xl bg-[#0072bc] py-[9px] text-[14px] font-bold uppercase text-white"
      >
        Accesso Desde
      </button>
    </div>
